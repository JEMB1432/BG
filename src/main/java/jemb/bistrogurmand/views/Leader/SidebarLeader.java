...
public class SidebarLeader extends VBox {
    ...
    private void createMenu() {
        ...
        VBox menuButtons = new VBox(8, btnSummary, btnOrderChange, btnPlanification);
